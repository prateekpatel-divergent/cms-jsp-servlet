	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				<div class="row">
					<div class="col-md-6">
						<form class="form-horizontal" action="patientController"
							method="POST">
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<input id="gender" name="gender" type="number"
											placeholder="" class="form-control input-md">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<input id="contactno" name="contactno" type="text" placeholder=""
											class="form-control input-md">
								...
								<tbody>
									<c:forEach items="${allPatient}" var="patient">
										<tr>
											...
											<td><a href="patientController?id=${patient.id}"
